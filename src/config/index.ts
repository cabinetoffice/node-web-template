...
export const PATH_SSL_PRIVATE_KEY = process.env["PATH_SSL_PRIVATE_KEY"] as string;
export const PATH_SSL_CERTIFICATE = process.env["PATH_SSL_CERTIFICATE"] as string;
